            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="input-group input-group-sm my-3">
                            <input style="height: 45px;" type="text" class="form-control" id="cari-pegawai" name="q"
                                placeholder="ketikkan Nama / NIP untuk pencarian">
                ...
                <div class="col-md-6">
                    <h4 class="card-title">Daftar Anggota
                        {{$data['kegiatanJabatan']->mKegiatanJabatan->kegiatan_jabatan_nama}} (<span
                            id="totalAnggota"></span> Anggota)</h4>
                    <div class="row">
                        <div class="input-group input-group-sm my-3">
                            <input style="height: 45px;" type="text" class="form-control" name="q"
                                placeholder="ketikkan Nama / NIP untuk pencarian">
                            <button class="btn btn-primary" type="button"><i class="fa fa-search"></i></button>
                        </div>
                    </div>
