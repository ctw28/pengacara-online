...
class KegiatanController extends Controller
{
    ...
    public function getKegiatanPeserta($id)
    { //ini untuk dapat semua peserta per kegiatan
    ...
    public function getPesertaPerSesiPembayaran($pembayaranSesiId)
    { //untuk dapat peserta per sesi pembayaran
    ...
    public function getKegiatanPesertaJenisPembayaran($id)
    { //ini untuk dapat semua peserta per kegiatan
        $data = KegiatanPeserta::whereHas('kegiatanJabatan', function ($kegiatanJabatan) use ($id) {
            $kegiatanJabatan->where('kegiatan_id', $id);
        })->get();
    ...
    { //ini untuk dapat 1 peserta saja
        $data = KegiatanPeserta::find($request->id);
        return $data;
    }

    public function getPenerima($kegiatanId)
    { //ini untuk ambil daftar penerima
